  ...
  return (
    ...
    >
      <Container sx={{ pt: 5, pb: 3 }}>
        <Grid container>
          <Grid item lg={3} md={3} sm={6} xs={12} sx={{ my: 2 }}>
            <Typography variant="h5" sx={{ mb: 1 }}>
              ABOUT
            </Typography>
            <Typography variant="subtitle1">Investors</Typography>
            <Typography variant="subtitle1">Supplier Responsibility</Typography>
        ...
        <Typography variant="subtitle1" sx={{ mt: 4 }}>
          &copy; 2022 Khondoker Aashabul Imam All Rights Reserved.
        </Typography>
      </Container>
    </Box>
  );
